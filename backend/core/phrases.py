...
class Phrases:
    ...
    pick_amount = f'🔽 Напишите <b>сумму</b>, которую вы хотите <b>продать</b>:️'
    err_amount = f'Неверный ввод! Введите только положительное число. \n<b>Сумма</b>, которую вы хотите <b>продать</b>:'
    emoji = {'Турция': '🇹🇷',
             'Россия': '🇷🇺',
             'Грузия': '🇬🇪',
             'Армения': '🇦🇲',
